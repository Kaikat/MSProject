Thank you for downloading the Shark.

This is a realistic 3d model and animations of Shark. 
-Models folder contains SharkModelLowPoly.FBX, SharkModelMiddlePoly.FBXand SharkModelTwoLODs.FBX.
...
Demo folders contains example use of the Shark.
