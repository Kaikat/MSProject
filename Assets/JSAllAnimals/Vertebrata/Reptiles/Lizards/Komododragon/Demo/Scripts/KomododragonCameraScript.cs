...
public class KomododragonCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject komododragonCamera;
	...
	void Update(){
		...
		komododragonCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
