...
public class LeaftailedgeckoCamera : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject leaftailedgeckoCamera;
	...
	void Update(){
		...
		leaftailedgeckoCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
