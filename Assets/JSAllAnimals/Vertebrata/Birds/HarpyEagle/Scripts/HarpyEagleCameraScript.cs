...
public class HarpyEagleCameraScript : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject harpyEagleCamera;
	...
	void Update(){
		...
		harpyEagleCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
