...
public class ManedWolfCameraScriot : MonoBehaviour {
	public GameObject target;
	public float turnSpeed=.2f;
	public GameObject manedWolfCamera;
	...
	void Update(){
		...
		manedWolfCamera.transform.localPosition = new Vector3 (0f,cameraDistance,-2f*cameraDistance);
	}
