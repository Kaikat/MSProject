...
public class AnimalData  
{
	...
	public string NahuatlName { private set; get; }
	public string SpanishName { private set; get; }
	...
	public AnimalData(AnimalSpecies species, string name, string nahuatlName, string spanishName, string description, HabitatLevelType habitat, 
		float min_size, float max_size, float min_age, float max_age, float min_weight, float max_weight, string colorFile)
	{
		Species = species;
		Name = name;
		NahuatlName = nahuatlName;
